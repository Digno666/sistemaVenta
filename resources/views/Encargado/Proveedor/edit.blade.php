...
@section('title', 'Editar Proveedor - BODY FIT Admin')
...
<div class="form-container">
    <div class="form-header">
        ...
        <p class="form-subtitle">Modifica los datos del proveedor</p>
    </div>
    ...
    <div class="form-card">
        <form method="POST" action="{{ route('proveedor.update', $proveedor->codProveedor) }}" id="proveedorForm">
            @csrf
            @method('PUT')
            ...
            <div class="form-section">
                ...
                <div class="form-row">
                    <div class="form-group">
                        <label for="codProveedor">Código</label>
                        <div class="input-icon">
                            <i class="fas fa-hashtag"></i>
                            <input type="text" class="form-control" value="#{{ $proveedor->codProveedor }}" disabled>
                        </div>
                        <div class="input-help">
                            <i class="fas fa-info-circle"></i> El código es autoincremental y no se puede modificar
                        </div>
                    </div>
