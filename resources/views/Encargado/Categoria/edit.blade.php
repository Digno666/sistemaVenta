...
@section('title', 'Editar Categoría - BODY FIT Admin')
...
<div class="form-container">
    <div class="form-header">
        ...
        <p class="form-subtitle">Modifica los datos de la categoría</p>
    </div>
    ...
    <div class="form-card">
        <form method="POST" action="{{ route('categoria.update', $categoria->codCategoria) }}" id="categoriaForm">
            @csrf
            @method('PUT')
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <div class="input-icon">
                            ...
                            <input type="text" class="form-control" value="{{ $categoria->codCategoria }}" disabled>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-icon">
                            ...
                            <input type="text" name="nombre" id="nombre" class="form-control @error('nombre') is-invalid @enderror" 
                                   value="{{ old('nombre', $categoria->nombre) }}" placeholder="Ej: Suplementos, Ropa Deportiva" required>
                        </div>
                        @error('nombre')
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-icon">
                            ...
                            <textarea name="descripcion" id="descripcion" rows="5" class="form-control @error('descripcion') is-invalid @enderror" 
                                      placeholder="Describe los productos que pertenecen a esta categoría..." required>{{ old('descripcion', $categoria->descripcion) }}</textarea>
                        </div>
                        @error('descripcion')
                            <span class="error-text"><i class="fas fa-exclamation-circle"></i> {{ $message }}</span>
                        @enderror
