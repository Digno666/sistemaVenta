...
@section('title', 'Mi Perfil - BODY FIT')
...
<div class="perfil-container">
    ...
    <div class="perfil-card">
        <div class="perfil-avatar">
            @if($cliente && $cliente->foto_url)
                <div class="avatar-image">
                    <img src="{{ $cliente->foto_url }}" alt="Foto de perfil">
                </div>
            @else
        ...
        <div id="tab-info" class="tab-content active">
            <div class="perfil-info">
                ...
                <div class="info-group">
                    ...
                    <p>{{ number_format($cliente->carnetIdentidad, 0, '', '.') }}</p>
                </div>
                ...
                <div class="info-group">
                    <label>Sexo</label>
                    <p>{{ $cliente->sexo == 'M' ? 'Masculino' : 'Femenino' }}</p>
                </div>
                ...
                <div class="info-group incomplete">
                    ...
                    <p>Debes completar tu información personal para realizar compras</p>
                    <a href="{{ route('cliente.perfil.completar') }}" class="btn-completar">
        ...
        <div id="tab-edit" class="tab-content">
            <form method="POST" action="{{ route('cliente.perfil.update') }}" id="perfilForm" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-icon">
                                ...
                                <input type="text" name="celular" id="celular" class="form-control" 
                                       value="{{ old('celular', $cliente->celular ?? '') }}" placeholder="Ej: 71234567">
                            </div>
                            <div class="input-help">
                                <i class="fas fa-info-circle"></i> Solo números, sin espacios
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="form-group">
                            ...
                            @if($cliente && $cliente->foto_url)
                                <div class="current-photo">
                                    <img src="{{ $cliente->foto_url }}" alt="Foto actual" class="current-photo-img">
...
<style>
    ...
    input[type="file"].form-control i {
        display: none;
    }
...
<script>
    ...
    function uploadPhoto(input) {
        if (input.files && input.files[0]) {
            ...
            fetch('{{ route("cliente.perfil.upload-photo") }}', {
                method: 'POST',
                body: formData,
                headers: {
